...
const loaders: Record<Locale, Record<Namespace, Loader>> = {
  en: {
    ...
    dashboard: () => import("@/dictionaries/en/dashboard.json"),
    competitions: () => import("@/dictionaries/en/competitions.json"),
    settings: () => import("@/dictionaries/en/settings.json"),
  ...
  fr: {
    ...
    dashboard: () => import("@/dictionaries/fr/dashboard.json"),
    competitions: () => import("@/dictionaries/fr/competitions.json"),
    settings: () => import("@/dictionaries/fr/settings.json"),
  ...
  es: {
    ...
    dashboard: () => import("@/dictionaries/es/dashboard.json"),
    competitions: () => import("@/dictionaries/es/competitions.json"),
    settings: () => import("@/dictionaries/es/settings.json"),
  ...
  nl: {
    ...
    dashboard: () => import("@/dictionaries/nl/dashboard.json"),
    competitions: () => import("@/dictionaries/nl/competitions.json"),
    settings: () => import("@/dictionaries/nl/settings.json"),
