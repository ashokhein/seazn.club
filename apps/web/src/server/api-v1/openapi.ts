...
export const ROUTES: RouteSpec[] = [
  ...
  { path: "/divisions/{id}/schedule/ai-plan", method: "post", summary: "AI Schedule Architect: propose times+courts (generate/refine/repair), engine-verified; propose-only; all plans (`scheduling.ai`), capped per division by `scheduling.ai.runs_per_division.max` (5 free / 10 Event Pass / 20 Pro / 50 Pro Plus)", tag: "scheduling", request: S.AiPlanRequest, response: S.AiPlanResponse, errors: [400, 402, 403, 409, 422, 429] },
