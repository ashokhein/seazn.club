---
title: Sponsors
description: Tiered sponsor logos on your public pages — and selling sponsorship packages by card.
order: 6
---
...
**Where do the logos appear?** The public competition page footer, the registration masthead and the slideshow strip.

**My old sponsors are still there?** Existing sponsor lists were migrated automatically as Partner-tier entries — nothing was lost.

**A sponsor paid but isn't showing?** Placement activates when Stripe confirms the payment (usually seconds). Check the order's status in the API or contact support if it stays pending.
