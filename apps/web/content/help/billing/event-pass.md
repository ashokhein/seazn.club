...
**Your entry-fee rate is the exception, and it stays cheap.** Once a competition has taken its **first paid entry**, the platform fee that competition charges is **locked for the rest of it** — so it does not rise when the pass stops applying, and a late entrant pays the same 5% as the first one. Only a competition that never took a paid entry moves to your plan's live rate.
