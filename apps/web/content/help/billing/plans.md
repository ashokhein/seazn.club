...
description: Community is free forever and already charges entry fees and carries your logo; an Event Pass lifts one competition; Pro adds your brand colour, bigger limits and integrations; Pro Plus adds unlimited scale and a write API for platforms and federations — and one subscription can cover several organisations.
order: 1
---
...
Charging entry fees is free on every plan — Community included. What the plan changes is the platform fee we keep on card payments:
...
Stripe's own processing fee is separate and set by Stripe. The whole money journey — Connect, payouts, refunds and disputes — is in [how card entry fees flow](/help/registration/card-payments).
